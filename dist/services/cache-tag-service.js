 ...
 * - Case insensitive
 */
export class DefaultCacheTagService {
    /**
     ...
     */
    constructor(namespace = globalThis.CACHE_TAG_NAMESPACE || 'cf', maxTags = parseInt(globalThis.MAX_CACHE_TAGS || '10', 10)) {
        this.maxTagLength = 1024; // Cloudflare limit for purge API
        this.maxHeaderLength = 16 * 1024; // Cloudflare 16KB limit
    ...
    generateTags(request, assetType) {
        ...
        const generatedTags = [...new Set(tagsWithPriority
...
//# sourceMappingURL=cache-tag-service.js.map